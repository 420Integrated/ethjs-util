...
```
git clone http://github.com/420integrated/fourtwozerojs-util
npm install
```
...
Please help better the ecosystem by submitting issues and pull requests. We need all the help we can get to build the absolute best linting standards and utilities. We follow the AirBNB linting standard. Please read more about contributing to `fourtwozerojs-util` in the `.github/CONTRIBUTING.md`.
